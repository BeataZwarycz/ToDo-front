...
requestLoadCategory.open('GET', 'https://to-do-coderscamp.herokuapp.com/api/category/', true);
...
requestLoadCategoryTasks.open('GET', 'https://to-do-coderscamp.herokuapp.com/api/tasks/:categoryId', true);
requestLoadCategoryTasks.onload = function () {

    // Begin accessing JSON data here
    var data = JSON.parse(this.response);
    if (requestLoadCategoryTasks.status >= 200 && requestLoadCategoryTasks.status < 400) {
        data.forEach(Tasks => {
            const card = document.createElement('div');
...
requestEditTask.open('GET', 'https://to-do-coderscamp.herokuapp.com/api/tasks/:id', true);
